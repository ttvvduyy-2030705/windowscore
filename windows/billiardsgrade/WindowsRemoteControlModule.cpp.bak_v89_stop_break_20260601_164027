...
namespace
{
    ...
    std::string LogicalKeyFromVirtualKey(VirtualKey key)
    {
        ...
        case 107:
            return "EXTENSION";
        case 175: // Real Windows HID mapping: physical ThÃƒÂªm giÃ¡Â»Â sends VolumeUp.
            return "EXTENSION";
        case 84:
        case 109:
            return "TIMER";
        case 174: // Real Windows HID mapping: physical BÃ¡ÂºÂ¥m giÃ¡Â»Â sends VolumeDown.
            return "TIMER";
        case 13:
        case 30:
        case 41:
    ...
    void EmitAcceleratorRemoteEvent(CoreDispatcher const &, AcceleratorKeyEventArgs const &args)
    {
        ...
        // This remote exposes BÃ¡ÂºÂ¥m giÃ¡Â»Â / ThÃƒÂªm giÃ¡Â»Â as system volume keys on Windows.
...
namespace winrt::billiardsgrade::implementation
{
    ...
    void RemoteControlModule::SetEnabled(bool enabled) noexcept
    {
        ...
        if (enabled)
        {
            // Must be installed when the in-game Ã„ÂiÃ¡Â»Âu khiÃ¡Â»Æ’n toggle is enabled.
